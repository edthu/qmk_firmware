...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [WIN_B] = LAYOUT(
        ...
        KC_PGDN, KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_BSLS,
     MO(WIN_FN), KC_LSFT, KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_RALT,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_UP,   KC_RSFT,
                 KC_LGUI, KC_LCTL,                            KC_LALT, LT(LAYER_2, KC_SPC),  LT(MOUSE_LAYER, KC_ENT),  KC_BSPC,                            KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [LAYER_2] = LAYOUT(
        KC_DEL,  KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_NUHS, KC_BSPC,
        RGB_TOG, KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
        KC_PGDN, KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_LEFT,    KC_DOWN,    KC_UP,    KC_RIGHT,    KC_SCLN, KC_QUOT,          KC_BSLS,
     MO(WIN_FN), KC_LSFT, KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_RALT,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_UP,   KC_RSFT,
                 KC_LCTL, KC_LGUI,                            KC_LALT, _______, KC_ENT,  KC_BSPC,                            KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [MOUSE_LAYER] = LAYOUT(
        _______, _______,  _______,   _______,   _______,   _______,   _______,  _______,   _______,   _______,   _______,   _______,  _______,  _______,  _______, _______,
        _______, _______, MS_WHLU, MS_UP, MS_WHLD, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, MS_LEFT, MS_DOWN, MS_RGHT, _______, _______, _______, MS_BTN1, MS_BTN2,  _______, _______, _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
